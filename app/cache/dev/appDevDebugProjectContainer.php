...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'symfonyComments', 'user' => 'root', 'password' => 'coderslab', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/CommentsBundle/Entity'))), 'CommentsBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('CommentsBundle' => 'CommentsBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_06c35f5128fe501ef6910d704d51dfad38b1471811b259599d4928e9c8e3ac30');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/CommentsBundle/Resources/views'), 'Comments');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('7d59954982d4348baf23f9f07d68d5f802ef017a');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5a2acee89d4e96.37592658')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'CommentsBundle' => 'CommentsBundle\\CommentsBundle',
            ...
            'kernel.bundles_metadata' => array(
                ...
                'CommentsBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/CommentsBundle'),
            ...
            'secret' => '7d59954982d4348baf23f9f07d68d5f802ef017a',
            'locale' => 'en',
            ...
            'kernel.secret' => '7d59954982d4348baf23f9f07d68d5f802ef017a',
